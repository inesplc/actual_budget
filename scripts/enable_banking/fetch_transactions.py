...
def authenticate(headers, r2_client, current_session=None):
    ...
    if current_session:
        ...
        # Save to R2
        write_to_r2(r2_client, R2_SESSION_KEY, json.dumps(session, indent=2))
    else:
...
def main():
    ...
    # Load Session
    session_data = None
    session_json = read_from_r2(r2, R2_SESSION_KEY)
    if session_json:
